...
# cd to system root for known starting location
#
cd /
apt update
apt upgrade -y
...
mkdir -p /usr/share/fonts/nerdfonts && mv -v ./* /usr/share/fonts/nerdfonts/
cd / && rm -rf nerd-fonts
...
#
# Download $ install basic utilities
#

apt install -y neofetch htop lolcat php-zip net-tools nano